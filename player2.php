...
$sql2 = "UPDATE `" . $game . "` SET box1y=" . $box1y . ",box2y=" . $box2y . ",box3y=" . $box3y . ",box1x=" . $box1x . ",box2x=" . $box2x . ",box3x=" . $box3x . " WHERE turn=" . $turn;
mysql_query($sql2);



$sql = "SELECT player1x,player1y FROM `" . $game . "` WHERE turn=" . $turn;
...
$sql3 = "SELECT player1ready FROM `" . $game . "` WHERE turn=" . $turn;
